        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('') }}images-admin/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('') }}images-admin/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('') }}images-admin/logo-text.png" alt="">
            </a>
