...
<div class="card">
    ...
    <div class="card-body">
        <div class="basic-form">
            <form action="/dashboard/gallerys/{{ $gallery->id }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                @if($gallery->image)
                <img src="{{ asset('storage/' . $gallery->image) }}" class="img-preview img-fluid mb-3 col-sm-3">
                @else
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control @error('caption')is-invalid @enderror" name="caption" id="caption" placeholder="Caption"> {{ old('caption', $gallery->caption) }}</textarea>
                        @error('caption')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
